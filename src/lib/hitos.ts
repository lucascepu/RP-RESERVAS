...
export const HITOS: Hito[] = [
  ...
  },
  {
    id: 'bcra-11000-mm',
    fecha: '2026-06-25',
    titulo: 'BCRA supera los USD 11.000 MM de compras en 2026',
    descripcion: 'Las compras netas acumuladas del BCRA en el mercado de cambios alcanzan los USD 11.043 MM, superando el hito de USD 11.000 MM en el año.',
    tag: 'bcra',
    indicador: 'compras',
    fuente: 'BCRA',
    automatico: false,
