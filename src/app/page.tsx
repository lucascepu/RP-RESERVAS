      ...
      <section className={styles.cards}>
        ...
        {compData ? (
          <KpiCard
            ...
            subInfo2={`Últ. 5 ruedas: +${compData.acum5ruedas.toLocaleString('es-AR')} MM · Vol: ${compData.vol5ruedas.toLocaleString('es-AR')} MM · Acum. 2026: +${Math.round(compData.acumAnio).toLocaleString('es-AR')} MM`}
          />
